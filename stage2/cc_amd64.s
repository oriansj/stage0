...
:collect_local
	...
	LOADI R0 -40                ; The default depth for main
	STORE32 R0 R2 16            ; A->DEPTH = -40
...
:collect_local_1
	...
	SUBI R0 R0 16               ; DEPTH = FUNC->ARGS->DEPTH - 16
...
:collect_local_2
	...
	SUBI R0 R0 8                ; DEPTH = FUNC->LOCALS->DEPTH - 8
	STORE32 R0 R2 16            ; A->DEPTH = DEPTH
...
:collect_arguments_func
	...
	LOAD32 R0 R0 16             ; FUNC->ARGS->DEPTH
	SUBI R0 R0 8                ; FUNC->ARGS->DEPTH - 8 or NULL - 8 (-8)
